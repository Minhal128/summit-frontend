    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            try {
                ...
                const dashboardUrl = process.env.NEXT_PUBLIC_DASHBOARD_URL || 'https://dashboardsummit.vercel.app';
    ...
    return (
        ...
        >
            ...
            <main className="relative z-10 flex-grow flex items-center justify-center px-4 py-8 sm:px-8 sm:py-16">
                <div className="w-full max-w-3xl bg-[#10233D] backdrop-blur-md border border-slate-800 rounded-2xl shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-10 overflow-hidden mobile-container" style={{ margin: '20px' }}>
                
                    {/* Form Section */}
                    <div className="p-8 rounded-l-2xl mobile-form" style={{ marginTop: '30px' }}>
                        <h1 className="text-3xl font-bold text-white mb-2 mobile-title" style={{ marginLeft: '20px' }}>Login to your account</h1>
                        <p className="text-gray-400 text-sm mb-8 mobile-subtitle" style={{ marginLeft: '20px', marginTop: '8px' }}>
                        ...
                        {/* Login Method Toggle */}
                        <div className="bg-[#10233D] rounded-lg grid grid-cols-2 mb-10 p-2 mobile-toggle" style={{ marginLeft: '20px', marginTop: '20px', gap: '10px', marginBottom: '20px', width: 'calc(100% - 40px)' }}>
                            <button
                                type="button"
                                onClick={() => setLoginMethod('email')}
                                className={cn(
                                    "py-4 px-6 rounded-md text-base font-semibold transition-colors duration-200 h-12",
                                    loginMethod === 'email' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-slate-700'
                                )}
                            >
                                Email Address
                            </button>
                            <button
                                ...
                                className={cn(
                                    "py-4 px-6 rounded-md text-base font-semibold transition-colors duration-200 h-12",
                                    loginMethod === 'phone' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-slate-700'
                                )}
                            >
                                Phone number
                            </button>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-12">
                            ...
                            {loginMethod === 'phone' && (
                                <div className="flex items-center gap-2 mobile-responsive-inputs" style={{ marginLeft: '20px', marginBottom: '20px' }}>
                            ...
                            <div className="relative mobile-responsive-inputs" style={{ marginLeft: '20px' }}>
                                <Input 
                            ...
                            <div className="text-center pt-4 mobile-responsive-link" style={{ marginLeft: '20px', marginTop: '20px' }}>
                                <button 
                                    type="button"
