...
import { CreditCard, Loader2, CheckCircle, XCircle, Key, Smartphone } from 'lucide-react';
...
export default function NfcLoginCard({ onSuccess, onError }: NfcLoginCardProps) {
  ...
  /**
   * Login with physical NFC card tap (PRODUCTION)
   */
  ...
  /**
   * Login with manual card ID (DEMO/fallback)
   */
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Login securely using your NFC card
        </CardDescription>
      </CardHeader>
      <CardContent>
        {renderStepContent()}
